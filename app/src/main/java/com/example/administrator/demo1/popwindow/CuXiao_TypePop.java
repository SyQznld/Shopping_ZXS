...
import com.example.administrator.demo1.adapter.CuXiao_TypeAdapter;
 ...
 */
public class CuXiao_TypePop extends PopupWindow {

    private View contentView;
    private GridView gridView_shop_pop;
    private CuXiao_TypeAdapter sgAdapter;
    int pg = 1;
    private List<CuXiaoBean.TypesBean> sitesBeen = new ArrayList<>();
    public CuXiao_TypePop(final Activity context){
        ...
        sgAdapter = new CuXiao_TypeAdapter(context,sitesBeen);
    ...
    private void initShopGrid() {
        ...
        call.enqueue(new Callback<CuXiaoBean>() {
            ...
            public void onResponse(Call<CuXiaoBean> call, Response<CuXiaoBean> response) {
                List<CuXiaoBean.TypesBean> sites = response.body().getTypes();
