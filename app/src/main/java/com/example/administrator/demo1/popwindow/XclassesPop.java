...
public class XclassesPop extends PopupWindow{
    private View contentView;
    private List<XClassesBean> classesBeen = new ArrayList<>();
    private List<XPopTotalBean.ClassesBean.NextBean> popBeen = new ArrayList<>();
    private XPopNextAdapter xnAdapter;
    private ListView listView;
    private ListView listView_right;
    private ClassesAdapter classesAdapter;
    public XclassesPop(final Activity context){
        ...
        xnAdapter = new XPopNextAdapter(context,popBeen);
       ...
       //http://app.gwdang.com/app/price_zhi?ps=20&is_haitao=1&format=json&img_width=375&current_time=1477111800&version=2
        ...
        call.enqueue(new Callback<XPopTotalBean>() {
            ...
            public void onResponse(Call<XPopTotalBean> call, Response<XPopTotalBean> response) {
                List<XPopTotalBean.ClassesBean.NextBean> next = response.body().getClasses().get(position).getNext();
