 ...
 */
public class CuXiao_ClassAdapter extends BaseAdapter {

    Context mContext;
    List<CuXiaoBean.ClassesBean> list;
    LayoutInflater inflater;

    public CuXiao_ClassAdapter(Context mContext, List<CuXiaoBean.ClassesBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CuXiaoBean.ClassesBean bean = list.get(position);
        if (bean != null) {
