 ...
 */
public class CuXiao_ClassPop extends PopupWindow{

    private View contentView;
    private GridView gridView_shop_pop;
    private CuXiao_ClassAdapter sgAdapter;
    int pg = 1;
    private List<CuXiaoBean.ClassesBean> sitesBeen = new ArrayList<>();
    public CuXiao_ClassPop(final Activity context){
        ...
        sgAdapter = new CuXiao_ClassAdapter(context,sitesBeen);
    ...
    private void initShopGrid() {
        ...
        call.enqueue(new Callback<CuXiaoBean>() {
            ...
            public void onResponse(Call<CuXiaoBean> call, Response<CuXiaoBean> response) {
                List<CuXiaoBean.ClassesBean> sites = response.body().getClasses();
