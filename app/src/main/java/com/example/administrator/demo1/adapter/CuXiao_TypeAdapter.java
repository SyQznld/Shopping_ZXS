 ...
 */
public class CuXiao_TypeAdapter extends BaseAdapter {

    Context mContext;
    List<CuXiaoBean.TypesBean> list;
    LayoutInflater inflater;

    public CuXiao_TypeAdapter(Context mContext, List<CuXiaoBean.TypesBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CuXiaoBean.TypesBean bean = list.get(position);
        if (bean != null) {
