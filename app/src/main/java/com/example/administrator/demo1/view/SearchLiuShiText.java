...
public class SearchLiuShiText extends ViewGroup {


    public SearchLiuShiText(Context context) {
        super(context);
    }

    public SearchLiuShiText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < mAllViews.size(); i++) {
            ...
            for (int j = 0; j < lineViews.size(); j++) {
                ...
                int childL = paddingLeft + lp.leftMargin;
                int childT = paddingTop + lp.topMargin;
                ...
                // 叠加   前一个View 的 实际宽度
                paddingLeft += view.getMeasuredWidth() + lp.leftMargin + lp.rightMargin;
            }
            // 换行了    left 恢复
