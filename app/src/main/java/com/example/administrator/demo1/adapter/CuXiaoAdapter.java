...
public class CuXiaoAdapter extends BaseAdapter {
    ...
    List<CuXiaoBean.PromotionBean> list;
    Context context;
    LayoutInflater inflater;

    public CuXiaoAdapter(List<CuXiaoBean.PromotionBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CuXiaoBean.PromotionBean promotionBean = list.get(position);
