 ...
 */
public class YouHui_ClassAdapter extends BaseAdapter {

    Context mContext;
    List<ZbYouHuiBean.ClassListBean> list;
    LayoutInflater inflater;

    public YouHui_ClassAdapter(Context mContext, List<ZbYouHuiBean.ClassListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ZbYouHuiBean.ClassListBean bean = list.get(position);
        if (bean != null) {
