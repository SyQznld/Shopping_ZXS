 ...
 */
public class GuoNeiDetailPop extends PopupWindow {


    private View conentView;

    public  GuoNeiDetailPop(final Activity context) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.guonei_detail_popwindow, null);
