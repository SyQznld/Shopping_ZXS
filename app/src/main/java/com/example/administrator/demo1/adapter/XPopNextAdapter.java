...
public class XPopNextAdapter extends BaseAdapter {
    Context mContext;
    List<XPopTotalBean.ClassesBean.NextBean> list;
    LayoutInflater inflater;

    public XPopNextAdapter(Context mContext,List<XPopTotalBean.ClassesBean.NextBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        XPopTotalBean.ClassesBean.NextBean bean = list.get(position);
        if (bean != null) {
