...
import com.example.administrator.demo1.adapter.YouHui_SitesAdapter;
 ...
 */
public class YouHui_SitesPop extends PopupWindow {
    private View contentView;
    private GridView gridView_shop_pop;
    private YouHui_SitesAdapter sgAdapter;
    int pg = 1;
    private List<ZbYouHuiBean.SiteListBean> sitesBeen = new ArrayList<>();
    public YouHui_SitesPop(final Activity context){
        ...
        sgAdapter = new YouHui_SitesAdapter(context,sitesBeen);
    ...
    private void initShopGrid() {
        ...
        call.enqueue(new Callback<ZbYouHuiBean>() {
            ...
            public void onResponse(Call<ZbYouHuiBean> call, Response<ZbYouHuiBean> response) {
                List<ZbYouHuiBean.SiteListBean> sites = response.body().getSite_list();
