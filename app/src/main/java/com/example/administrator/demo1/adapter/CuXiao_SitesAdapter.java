 ...
 */
public class CuXiao_SitesAdapter extends BaseAdapter {

    Context mContext;
    List<CuXiaoBean.SitesBean> list;
    LayoutInflater inflater;

    public CuXiao_SitesAdapter(Context mContext, List<CuXiaoBean.SitesBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CuXiaoBean.SitesBean bean = list.get(position);
        if (bean != null) {
